    ...
    <section className="mb-24 md:mb-32 mx-8">
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          A diverse collective of thinkers, makers, and problem-solvers united
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg hover-scale transition-all duration-300 border-t-4 border-blue-500 group hover:bg-gradient-to-b hover:from-blue-50 hover:to-white">
          ...
          <div className="flex justify-center gap-4">
            <a
              href="https://www.linkedin.com/in/mbinasif/"
              target="_blank"
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg hover-scale transition-all duration-300 border-t-4 border-purple-500 group hover:bg-gradient-to-b hover:from-purple-50 hover:to-white">
          ...
          <p className="text-gray-600 text-center mb-4">
            Design thinker bridging aesthetics and functionality across digital
            experiences.
          </p>
          <div className="flex justify-center gap-4">
            <a
              href="https://www.linkedin.com/in/muhammad-talha-100949260/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaLinkedin className="text-blue-600 hover:text-blue-800 text-xl" />
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg hover-scale transition-all duration-300 border-t-4 border-blue-500 group hover:bg-gradient-to-b hover:from-blue-50 hover:to-white">
          ...
          <p className="text-gray-600 text-center mb-4">
            Technology architect building scalable, future-proof digital
            solutions.
          </p>
          <div className="flex justify-center gap-4">
            <a
              href="https://www.linkedin.com/in/danyaal-majid/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaLinkedin className="text-blue-600 hover:text-blue-800 text-xl" />
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg hover-scale transition-all duration-300 border-t-4 border-blue-500 group hover:bg-gradient-to-b hover:from-blue-50 hover:to-white">
          ...
          <p className="text-purple-600 text-center mb-4">Video Editor Head</p>
          <p className="text-gray-600 text-center mb-4">
            Creative video editor with a passion for storytelling and visual
            effects. Expert in Adobe Premiere Pro and After Effects.
          </p>
          {/* <div className="flex justify-center gap-4">
            <a
              href="https://www.linkedin.com/in/mbinasif/"
