    ...
    <div style={{ display:"grid", gap:"20px", gridTemplateColumns:"1fr 1fr" }}>
      <div style={{ gridColumn:"1/-1" }}>
        <div className="bh-notice bh-notice-gold">
          <strong style={{ fontWeight:700 }}>Before you begin</strong> — Tell us who you are. Our editorial team reviews every guest post submission personally, so your background matters.
        </div>
      </div>
...
function Step2({ form, update }: { form: FormData; update: (k: keyof FormData, v: any) => void }) {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:"20px" }}>
      <div className="bh-notice bh-notice-gold">
        <strong style={{ fontWeight:700 }}>Up to 3 dofollow backlinks</strong> — Links appear in your author profile. For the highest SEO return, also embed them naturally inside your article body.
      </div>
...
function SuccessScreen() {
  return (
    <div style={{ minHeight:"50vh", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"60px 20px", textAlign:"center" }}>
      ...
      <h2 style={{ fontFamily:"'Playfair Display', serif", fontSize:"2.2rem", fontWeight:800, color:"#1a1a1a", margin:"0 0 14px" }}>Guest post received</h2>
      <p style={{ fontSize:14, lineHeight:1.8, color:"#666", maxWidth:420, margin:"0 0 32px" }}>
        Our editorial team will review your article and get back to you within 3–5 business days.
      </p>
        ...
        <header style={{ marginBottom:64 }}>
          ...
          */}
          <h1 style={{ fontFamily:"'Playfair Display', serif", fontSize:"clamp(2.4rem, 5vw, 3.6rem)", fontWeight:800, color:"#111", lineHeight:1.12, margin:"0 0 20px", maxWidth:620 }}>
            Write for Us —<br />Contribute to Bridge Homies
          </h1>

          <p style={{ fontSize:14.5, lineHeight:1.85, color:"#666", maxWidth:560, margin:"0 0 12px" }}>
            We accept guest posts from developers, architects, product managers, and founders who build real software for real businesses.
            Submit a guest post and get published in front of thousands of readers — plus earn up to 3 dofollow backlinks and a permanent author profile.
          </p>
          <p style={{ fontSize:13.5, lineHeight:1.8, color:"#888", maxWidth:560, margin:"0 0 36px" }}>
            We publish expert articles on <strong style={{ color:"#555" }}>custom web apps</strong>, <strong style={{ color:"#555" }}>admin dashboards</strong>, <strong style={{ color:"#555" }}>automation tools</strong>, <strong style={{ color:"#555" }}>AI integrations</strong>, <strong style={{ color:"#555" }}>SaaS platforms</strong>, <strong style={{ color:"#555" }}>eCommerce systems</strong>, and software built for growing businesses — everything beyond what WordPress handles.
          </p>
