  ...
  return (
    ...
    >
      ...
      <ParallaxBackground speed={0.3} className="absolute inset-0 -z-20">
        ...
        <div className="absolute bottom-1/4 -right-24 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl" />
      </ParallaxBackground>
      ...
      <div className="container relative z-10">
        <motion.div className="max-w-3xl mx-auto text-center" style={{ y: textY }}>
          ...
          <ScrollReveal direction="up" delay={0.2}>
            <motion.h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
              We Build{" "}
              <motion.span
          ...
          <ScrollReveal direction="up" delay={0.6}>
            <motion.div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  size="lg"
                  className="group bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 text-white shadow-lg hover:shadow-primary/20 transition-all duration-300"
                  onClick={handleClick}
                >
                  Get Started
        ...
        <ScrollReveal direction="up" delay={0.8}>
          <motion.div className="mt-16 relative">
            <motion.div
              className="relative mx-auto max-w-5xl overflow-hidden rounded-xl shadow-2xl shadow-primary/10"
              style={{
            ...
            <motion.div
              className="absolute -top-8 -left-8 md:top-8 md:left-8 p-4 bg-background/80 backdrop-blur-sm rounded-lg shadow-lg cursor-pointer border border-border/20"
              style={{
            ...
            <motion.div
              className="absolute -bottom-8 -right-8 md:bottom-8 md:right-8 p-4 bg-background/80 backdrop-blur-sm rounded-lg shadow-lg cursor-pointer border border-border/20"
              style={{
