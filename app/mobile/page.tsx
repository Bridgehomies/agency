        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mt-6">
              We offer comprehensive mobile app development services tailored to your business needs. From concept to deployment, we leverage AI and ML to deliver intelligent solutions that grow your business.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="service-card bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition">
              ...
              <h3 className="text-xl font-bold mb-3">Custom Mobile App Development</h3>
              <p className="text-gray-600 mb-4">
                Tailored mobile applications built with modern technologies to meet your specific business requirements.
              </p>
              <ul className="text-gray-600 space-y-2">
                <li className="flex items-center">
                  <i className="fas fa-check-circle text-green-500 mr-2">AI-Powered Features</i>
                </li>
                <li className="flex items-center">
            ...
            <div className="service-card bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition">
              ...
              <p className="text-gray-600 mb-4">
                Leverage artificial intelligence and machine learning to create intelligent apps that learn and adapt to user behavior.
              </p>
              <ul className="text-gray-600 space-y-2">
                <li className="flex items-center">
                  <i className="fas fa-check-circle text-green-500 mr-2">Personalized Recommendations</i>
                </li>
                <li className="flex items-center">
                  <i className="fas fa-check-circle text-green-500 mr-2">Predictive Analytics</i>
                </li>
                <li className="flex items-center">
                  <i className="fas fa-check-circle text-green-500 mr-2">Chatbots & Virtual Assistants</i>
                </li>
              </ul>
            </div>
            <div className="service-card bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition">
              ...
              <h3 className="text-xl font-bold mb-3">Growth-Driven Solutions</h3>
              <p className="text-gray-600 mb-4">
                Mobile apps designed to boost user engagement, retention, and revenue through data-driven strategies.
              </p>
              <ul className="text-gray-600 space-y-2">
                <li className="flex items-center">
                  <i className="fas fa-check-circle text-green-500 mr-2">Push Notifications</i>
                </li>
                <li className="flex items-center">
                  <i className="fas fa-check-circle text-green-500 mr-2">Gamification</i>
                </li>
                <li className="flex items-center">
                  <i className="fas fa-check-circle text-green-500 mr-2">User Analytics</i>
                </li>
              </ul>
            </div>
